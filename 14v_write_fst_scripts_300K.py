...
def write_batch_fst_computation(group_label, pred_fids, temp_dir):
  ...
  script_string = (
    "#!/bin/bash\n"
    f"#SBATCH -J fst_300K_{group_label}\n"
    f"#SBATCH -o fst_300K_{group_label}.o%j\n"
    f"#SBATCH -e fst_300K_{group_label}.o%j\n"
    "#SBATCH -p normal\n"
    "#SBATCH -N 1\n"
    "#SBATCH -n 4\n"
    "#SBATCH -t 36:00:00\n"
    ...
    "    --fam ${scratch}/ukb_merged/ukb_merged_edited_300K.fam \\\n"
    "    --family \\\n"
    "    --fst \\\n"
    ...
    "  grep 'Fst estimate:' ../data/fst/fst_${pred_fid}.log >> ../data/fst/fst_300K_${group}.est\n"
...
def main():
  temp_dir = pathlib.Path('temp_fst_300K_path/')
  temp_dir.mkdir(exist_ok=True)

  my_file = open("data/ukb_populations/pc_futher_fst_id_300K.txt", "r")
