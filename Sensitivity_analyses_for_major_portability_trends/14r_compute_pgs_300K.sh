#!/bin/bash
#SBATCH -J PGS_300K
#SBATCH -o PGS_300K.o%j
#SBATCH -e PGS_300K.o%j
#SBATCH -p normal
#SBATCH -N 1
#SBATCH -n 4
#SBATCH -t 8:00:00
...
do
  ...
  do
    ...
    $plink2 \
      --bfile ${scratch}/pgs/CT_merged_300K \
      --extract data/pgs/${phenotype}_300K_threshold_${threshold}.txt \
      --score data/gwas_results/${phenotype}_300K_combined.glm.linear 3 6 9 header no-mean-imputation \
      --memory 70000 \
      --out data/pgs/${phenotype}_300K_${threshold}_scores
  done
done
