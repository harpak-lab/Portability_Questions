...
fst <- read_tsv('data/fst/final_fst_300K.tsv')
pc_dist <- read_tsv("data/pca/pc_dist_300K.tsv")
pc_dist_further_rand_id <- read_tsv("data/ukb_populations/pc_futher_fst_id_300K.txt",
                                   col_names = "IID")
...
best_pc_dist %>% write_tsv("data/pca/pc_dist_best_300K.tsv")
...
best_pc_dist_gwas %>% write_tsv("data/pca/pc_dist_best_gwas_300K.tsv")
best_pc_dist_pred %>% write_tsv("data/pca/pc_dist_best_pred_300K.tsv")
...
best_pc_dist_gwas_std %>% write_tsv("data/pca/pc_dist_best_gwas_300K_std.tsv")
best_pc_dist_pred_std %>% write_tsv("data/pca/pc_dist_best_pred_300K_std.tsv")
